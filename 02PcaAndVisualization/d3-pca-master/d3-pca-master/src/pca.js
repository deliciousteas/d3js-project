const emlapack = require('./emlapack-custom'); // 基于 Emscripten 编译的 LAPACK 库

// dsyrk：用于计算矩阵的乘法（如协方差矩阵）。
// dsyev：用于计算矩阵的特征值和特征向量。
...
export { PCA, cov, eig }; // 使用 ES6 模块语法导出