...
export default {
  props: ["tabId","id","furnace","selTime","dataList"], 
  // name: 'D3Chart',
  data() {
    return {
  
  //      dataList:[
  //   { acqTime: '2024-07-16T00:00:09.000+08:00', zoneTempSp1: 770.66,zoneTempSp2: 770.66,zoneTempSp3: 770.66,
  //   zoneTempSp4: 770.66,zoneTempSp5: 770.66,zoneTempSp6: 770.66,zoneTempSp7: 770.66,zoneTempSp8: 770.66,
  //   zoneTempSp9: 770.66,zoneTempSp10: 770.66,zoneTempSp11: 770.66,zoneTempSp12: 770.66,zoneTempSp13: 770.66,
  //   zoneTempSp14: 770.66,
  //    zoneTemp1: 769.66,zoneTemp2: 769.66,
  //   zoneTemp3: 769.66,zoneTemp4: 769.66,zoneTemp5: 769.66,
  //   zoneTemp6: 769.66,zoneTemp7: 769.66,zoneTemp8: 769.66,zoneTemp9: 769.66,zoneTemp10: 769.66,zoneTemp11: 769.66,zoneTemp12: 
  //   769.66,zoneTemp13: 769.66,zoneTemp14: 769.66 },
  //   { acqTime: '2024-07-16T01:00:09.000+08:00', zoneTempSp1: 771.66,zoneTempSp2: 770.66,zoneTempSp3: 770.66,
  //   zoneTempSp4: 770.66,zoneTempSp5: 770.66,zoneTempSp6: 770.66,zoneTempSp7: 770.66,zoneTempSp8: 770.66,
  //   zoneTempSp9: 770.66,zoneTempSp10: 770.66,zoneTempSp11: 770.66,zoneTempSp12: 770.66,zoneTempSp13: 770.66,
  //   zoneTempSp14: 770.66, zoneTemp1: 770.66, zoneTemp2: 769.66,
  //   zoneTemp3: 769.66,zoneTemp4: 769.66,zoneTemp5: 769.66,
  //   zoneTemp6: 769.66,zoneTemp7: 769.66,zoneTemp8: 769.66,zoneTemp9: 769.66,zoneTemp10: 769.66,zoneTemp11: 769.66,zoneTemp12: 
  //   769.66,zoneTemp13: 769.66,zoneTemp14: 769.66},
  //   { acqTime: '2024-07-16T02:00:09.000+08:00', zoneTempSp1: 772.66,zoneTempSp2: 770.66,zoneTempSp3: 770.66,
  //   zoneTempSp4: 770.66,zoneTempSp5: 770.66,zoneTempSp6: 770.66,zoneTempSp7: 770.66,zoneTempSp8: 770.66,
  //   zoneTempSp9: 770.66,zoneTempSp10: 770.66,zoneTempSp11: 770.66,zoneTempSp12: 770.66,zoneTempSp13: 770.66,
  //   zoneTempSp14: 770.66,zoneTemp1: 771.66 ,zoneTemp2: 769.66,
  //   zoneTemp3: 769.66,zoneTemp4: 769.66,zoneTemp5: 769.66,
  //   zoneTemp6: 769.66,zoneTemp7: 769.66,zoneTemp8: 769.66,zoneTemp9: 769.66,zoneTemp10: 769.66,zoneTemp11: 769.66,zoneTemp12: 
  //   769.66,zoneTemp13: 769.66,zoneTemp14: 769.66},
  // ],
      ...
      displayedLines:[
        ...
        "zoneSp1","zoneSp2","zoneSp3","zoneSp4","zoneSp5","zoneSp6","zoneSp7","zoneSp7","zoneSp8","zoneSp9","zoneSp10","zoneSp11","zoneSp12",
        "zoneSp13","zoneSp14","zoneSp15","zoneSp16","zoneSp17","zoneSp18","zoneSp19","zoneSp20","zoneSp21",
      ],
      displayedLines2:["vacuumGauge"],
      displayedLines3:["furnacePressure"],
      displayedLines4:["dipWaterTemp1","dipWaterTemp2","dipWaterTemp3"],
      displayedLines5:["furnaceWaterTemp1","furnaceWaterTemp2","furnaceWaterTemp3"],
      displayedLines6:["lobularPumpFrq1","lobularPumpFrq2","lobularPumpFrq3"],
      displayedLines7:["power"],
  ...
  beforeUnmount() {
  // window.removeEventListener("resize", () => {this.renderChart()}); // 移除事件监听
},
  mounted() {
    // this.fetchData();

     // 如果数据在 mounted 时已经存在，初始化图表
    if (this.dataList && this.dataList.length > 0) {
     this.handleData();
    }
    // this.resizeChart()
    // window.addEventListener("resize", () => {this.renderChart()}); // 监听窗口变化
  },
  watch: { 
    dataList(){
      this.handleData()
  ...
  methods: {
    handleData() { 
      ...
      if (this.id == 1) {
        ...
        this.keys2 = Object.keys(this.dataList[0]).filter((key) => key.startsWith('frontOxa') || key.startsWith('rearOxa'));
        this.renderChart2()
      } 
      }); 
    },
  ...
  let that = this
  const margin = { top: 200, right: 30, bottom: 160, left: 60 };
...
const timeFormat = d3.timeFormat("%Y-%m-%d %H:%M:%S");
  ...
  const legendGroup = svg
    .append("g")
    .attr("transform", `translate(${margin.left},${height + margin.top - 500})`);
  ...
  .on("click", function (event, key) {
    ...
    console.log(that.displayedLines,'isDisplayedisDisplayedisDisplayed');
...
const timeFormat = d3.timeFormat("%Y-%m-%d %H:%M:%S");
  ...
  .attr("transform", () => {
    ...
    const yOffset = height + margin.top - 500; // 图例的初始 y 偏移量
